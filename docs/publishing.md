...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190530-snap">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190530-snap/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190530-snap/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190530-snap/",
      "url": "http://static.startribune.com/news/projects/all/20190530-snap/"
    }
  }
}
```
